...
1. [Public Trend Signal MVP](https://github.com/stomeonst/public-trend-signal-mvp), a credential-free Python and n8n proof for normalization, stable deduplication, deterministic scoring, human review routing, structured exports, and run receipts. The repository includes an importable inactive n8n workflow, eleven automated tests, and a passing public CI run.
2. [Public Repository Signal Notebook](https://github.com/stomeonst/public-repository-signal-notebook), a reproducible Python and SQLite technical writing sample built from 500 public GitHub repository records. Eight automated tests and six notebook code cells pass. Removing the GitHub stars component retains 45 of the baseline top 50 research priorities, a 90% overlap.
3. [EasyFind Chinese IME diagnosis](https://github.com/wowaddonmaker/EasyFind/pull/15), a reproducible open source bug diagnosis and patch proposal. On 19 July 2026, the maintainer confirmed that the root cause analysis directly shaped the composition aware fix released in [v2.1.3](https://github.com/wowaddonmaker/EasyFind/releases/tag/v2.1.3) and used the [issue 14 reproduction cases](https://github.com/wowaddonmaker/EasyFind/issues/14) for validation. The pull request was closed after the maintainer implemented a different primary approach, while the submitted locale fallback remains in the released implementation.
4. [Localize SaaS for China](https://github.com/stomeonst/localize-saas-for-china), a reusable evidence-safe China market launch skill. [Skillstore published the recovered submission](https://skillstore.io/skills/stomeonst-localize-saas-for-china) on 17 July 2026, and its [public skills.re audit](https://skills.re/skills/stomeonst/localize-saas-for-china/localize-saas-for-china/audit) scored 98 out of 100 on 15 July 2026.
5. [WeCom CLI batch demo](https://github.com/stomeonst/wecom-cli-batch-demo), a credential-free local workflow demonstration with idempotency, bounded retry, logs, and automated tests.
6. [Dated Web Change Evidence](https://github.com/stomeonst/dated-web-change-evidence), a zero-dependency Python sample that records visible HTML text with a UTC check time and SHA256 fingerprint. Four deterministic unit tests pass in release [v0.1.0](https://github.com/stomeonst/dated-web-change-evidence/releases/tag/v0.1.0).
7. [LaunchClear Capability Samples](https://github.com/stomeonst/launchclear-capability-samples), source-linked independent briefs covering a Chatwoot and AI support audit, a six-page English B2B SaaS website delivery plan, an automation repair walkthrough, and a reproducible public-data notebook. Every sample states its evidence and client relationship boundaries.
8. [Automation Rescue fictional sample](https://chris-saas-services.stomeonst123.chatgpt.site/resources/automation-rescue-sample), a field-mapping and duplicate-write repair walkthrough with an explicit acceptance test and no production-work claim.
